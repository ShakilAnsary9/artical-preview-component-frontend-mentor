    ...
    return (
        <div className='container'>
            ...
            <div className='right-side'>
                <h1>Shift the overall look and feel by adding these wounder full touches to furniture in your home.</h1>
                ...
                <div className='space'>
                    <div className='info'>
                        ...
                        <div className='info-txt'>
                            <h5>Michelle Appleton <br/> <span>28 Jun 2020</span></h5>
                        </div>
                    </div>
                    <Tippy offset={[0,20]} trigger='click' theme='tomato' interactive={true} className='tippy' content={
                        <div className='tip-flex'>
                            <div className='pop-share'>share</div>
